...
def index():
    if request.method == 'POST':
        ...
        albums = sorted(albums, key=lambda x: x['intYearReleased'])
        print(albums)
        return render_template('results.html', artist=artist_name, album=albums)
...
def search_albums(artist_name):
    ...
    URL = f'https://www.theaudiodb.com/api/v1/json/{API_KEY}/searchalbum.php?s={artist_name}'
